//
//  JGGuideViewController.m
//  AnimationDemo
//
//  Created by jgCho on 15/12/17.
...
#define btnH 35
#define btnW 140
@interface JGGuideViewController () <UIScrollViewDelegate>
/**
 *  底部滚动图片
 */
...
@implementation JGGuideViewController
...
- (void)viewDidLoad {
    ...
    /**
     滚动 辅助作用
     */
    UIScrollView *ado_guideView = [[UIScrollView alloc] initWithFrame:[UIScreen mainScreen].bounds];
